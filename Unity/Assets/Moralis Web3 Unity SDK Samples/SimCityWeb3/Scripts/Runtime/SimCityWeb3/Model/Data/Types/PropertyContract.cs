...
namespace MoralisUnity.Samples.SimCityWeb3.Model.Data.Types
{
	...
	public class PropertyContract : Contract
	{
		...
		public async UniTask<string> BurnPropertyNftAsync (PropertyData propertyData)
		{
			...
			{
				Debug.Log("BurnPropertyNft() failed. tokenId must be NOT null. Was this NFT just created. Leave and return to Scene so it gets loaded from online");
				return "";
			}
			
			Debug.Log($"BurnPropertyNft() tokenId = {tokenId}");
			object[] args =
			{
				tokenId
			};
