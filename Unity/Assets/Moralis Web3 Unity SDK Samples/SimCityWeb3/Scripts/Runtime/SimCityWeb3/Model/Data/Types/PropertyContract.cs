...
namespace MoralisUnity.Samples.SimCityWeb3.Model.Data.Types
{
	...
	public class PropertyContract : Contract
	{
		...
		public PropertyContract(ChainList chainList) : base(chainList)
		{
			switch (chainList)
			{
				case ChainList.mumbai:
					SetContractDetails_PolygonMumbai();
					break;
				case ChainList.cronos_testnet:
					SetContractDetails_CronosTestnet();
					break;
				default:
					SwitchDefaultException.Throw(chainList);
					break;
			}
		}

		protected void SetContractDetails_PolygonMumbai()
		{
			_address = "0x8039b52cE1B54f4700F53100A203E1Fe2E76B4F3";
		...
		protected void SetContractDetails_CronosTestnet()
		{
		}
